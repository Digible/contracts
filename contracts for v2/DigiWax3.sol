...
function getTotalSpotsByBoxName(string memory boxName) external view returns (uint){


 return tokensArr_by_boxName_map[boxName].length;

}

function getTotalKeysByBoxName (string memory boxName) external view returns (uint){

 return digiKeyTokensArr_by_boxName_map[boxName].length;

}

function getTotalWalletsByBoxName (string memory boxName) external view returns (uint){


 return participantWallets_by_boxName_map[boxName].length;
