...
// @dev DigiTrade Version 1c.
// + Added auto cxl of sale
...
contract DigiTrade is ERC721Holder, ReentrancyGuard, AccessControl {
    ...
    address public digiMarketPlaceAddress;
...
// @dev cancelOffer has 3 potential transactions (1 ERC20, 2 NFT)
    ...
    // To keep old marketplace address - use 0x0 for newMarketPlaceAddress
    function setGas(address _newMktPlaceAddress, address payable digiFeeCollectorAddress, uint256 _gasFee_MakeOffer, uint256 _gasFee_AcceptOffer, uint256 _gasFeeBps) public 
    {
        
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "YOU ARE NOT ADMIN");
        if(_newMktPlaceAddress != '0x0')  { digiMarketPlaceAddress = _newMktPlaceAddress };
